...
/**
 * format_event unit tests for upgradelib
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_event_upgrade_testcase extends advanced_testcase {
    ...
    public function test_numsections_no_actions() {
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course->id, 'format' => 'event',
    ...
    public function test_numsections_delete_empty() {
        ...
        $params1 = array('format' => 'event', 'numsections' => 5, 'startdate' => 1445644800);
        $course1 = $this->getDataGenerator()->create_course($params1);
        $params2 = array('format' => 'event', 'numsections' => 20, 'startdate' => 1445644800);
        ...
        $DB->insert_record('course_format_options', ['courseid' => $course1->id, 'format' => 'event',
