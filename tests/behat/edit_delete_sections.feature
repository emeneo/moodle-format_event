@format @format_event
Feature: Sections can be edited and deleted in event format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete event
  ...
  @javascript
  Scenario: Inline edit section name in event format
  ...
  Scenario: Deleting the last section in event format
  ...
  Scenario: Deleting the middle section in event format
  ...
  @javascript
  Scenario: Adding sections in event format
