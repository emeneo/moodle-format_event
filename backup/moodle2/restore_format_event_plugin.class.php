...
/**
 * Specialised restore for format_event
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_event_plugin extends restore_format_plugin {
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'event' || !isset($data['tags']['numsections'])) {
